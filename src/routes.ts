...
import { loggerMiddleware, validateBookMiddleware } from "./middlewares";
import { DATABASE_BOOKS } from "./database";

const router = Router();

router.use(loggerMiddleware);

router.post("/books", validateBookMiddleware,(req: Request, res: Response) => {
  const book = req.body;
